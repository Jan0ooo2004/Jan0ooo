...
const devs = ["482179798425403402","292053825546747905"];
const prefix = "&";
...
client.on ('message', msg => { 
    if (msg.content ===  'السلام عليكم') { 
      return msg.reply('وعليكم السلام');
    }
...
client.on('message' , message => {
 ...
 .setURL('https://discordapp.com/api/oauth2/authorize?client_id=489774312044101643&permissions=8&scope=bot')
  message.channel.sendEmbed(embed);
   }
});
...
client.on('message', message => {
    ...
    var omar;
      if(mentionned){
        ...
        .setFooter('All CopyRights Reseaved For  System team',client.user.avatarURL) 
      message.channel.sendEmbed(embed);
    }
})
